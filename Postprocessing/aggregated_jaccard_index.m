function aji = aggregated_jaccard_index(gt_map, predicted_map)
...
% unique integer
%load('./Valery_validation/TCGA-RD-A8N9-01A-01-TS1_gt_map.mat');
...
% unique integer
%load('./Valery_validation/TCGA-RD-A8N9-01A-01-TS1_predicted_map.mat');
% maximum number of predicted nuclei
